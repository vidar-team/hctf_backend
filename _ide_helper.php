 ...
 * Generated for Laravel 5.5.3 on 2018-08-23.
 *
...
namespace App\Facades { 
    ...
    class APIReturnFacade {
         ...
         * @static 
         */ 
        public static function success($data = array(), $redirect = null)
        {
            return \App\Services\APIReturnService::success($data, $redirect);
        }
         ...
         * @static 
         */ 
        public static function error($code, $message, $httpCode = 500, $redirect = null)
        {
            return \App\Services\APIReturnService::error($code, $message, $httpCode, $redirect);
        }
    ...
    class LoggerFacade {
         ...
         * @static 
         */ 
        public static function create($level = 'INFO', $message = '')
        {
            return \App\Services\LoggerService::create($level, $message);
        }
        ...
        {
            return \App\Services\LoggerService::debug($message);
        }
        ...
        {
            return \App\Services\LoggerService::info($message);
        }
        ...
        {
            return \App\Services\LoggerService::notice($message);
        }
        ...
        {
            return \App\Services\LoggerService::error($message);
        }
        ...
        {
            return \App\Services\LoggerService::critical($message);
        }
        ...
        {
            return \App\Services\LoggerService::alert($message);
        }
        ...
        {
            return \App\Services\LoggerService::emergency($message);
        }
...
namespace  { 
    ...
    class APIReturn extends \App\Facades\APIReturnFacade {}

    class JWTAuth extends \Tymon\JWTAuth\Facades\JWTAuth {}

    class JWTFactory extends \Tymon\JWTAuth\Facades\JWTFactory {}

    class Logger extends \App\Facades\LoggerFacade {}
